...
class webOSTV:
    ...
    def connect(self):
        ...
        try:
            ...
            expectedResonse = base64_encode(binascii.unhexlify('H*', sha1(self._wskey . '258EAFA5-E914-47DA-95CA-C5AB0DC85B11')))
    ...
    def run(self):
        tv = new webOSTV(self._host,3000,"785cff4fef58555ef82188b83cda579e")
        self.connect()                     //
        self.lg_handshake()
